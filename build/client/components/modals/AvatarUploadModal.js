...
var AvatarUploadModal = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, axiosApiInstance.post("/api/user/uploadImage", formData, {
                                headers: {
                    ...
                    case 2:
                        ...
                        if (response.status === 200) {
                            ...
                            context.setAvatarModalSaved(function (avatarModalSaved) { return !avatarModalSaved; });
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
    ...
    if (context.showAvatarModal === true) {
        return (_jsx(Background, __assign({ onClick: function () {
                ...
                } }, { children: [_jsx("label", { children: _jsx(Input
                        // style={{ display: "" }}
                        , { 
                            // style={{ display: "" }}
                            type: "file", name: "image", accept: "image/*" }) }), _jsx(Button, { text: "Save", type: "submit" })] })) })));
    }
    else {
